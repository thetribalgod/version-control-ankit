...
const ProfileInfo = () => {
	const userProfile = {
		...
		bio: "Ishani Ghosh",
		email: "shubhrolovesishani@gmail.com",
		followers: 100,
		following: 200,
		html_url: "https://github.com/burakorkmez",
		location: "Somewhere, Ishani ka dil",
		name: "Shubhro Jyoti Bhattacharjee",
		public_gists: 100,
		public_repos: 100,
		twitter_username: "ishanikapati",
		login: "boobro",
	};
